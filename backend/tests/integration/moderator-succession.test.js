...
describe('Integration: Moderator Succession', () => {
    ...
    beforeEach(async () => {
        ...
        await new Promise((resolve) => participant3Socket.once('connection-established', () => resolve()));
        const join3Data = await new Promise((resolve) => {
    ...
    afterEach(async () => {
        ...
        if (participant3Socket?.connected)
    ...
    it('should auto-promote first-joined participant when sole moderator leaves', async () => {
        ...
        const promotionPromises = [
            new Promise((resolve) => participant1Socket.once('moderator-promoted', resolve)),
            new Promise((resolve) => participant2Socket.once('moderator-promoted', resolve)),
            new Promise((resolve) => participant3Socket.once('moderator-promoted', resolve))
        ];
    ...
    it('should give newly promoted moderator full moderator privileges', async () => {
        ...
        const autoPromotionPromise = new Promise((resolve) => {
            participant1Socket.once('moderator-promoted', () => resolve());
        });
    ...
    it('should handle cascading auto-promotions when promoted moderator also leaves', async () => {
        ...
        const firstPromotionPromise = new Promise((resolve) => {
            participant1Socket.once('moderator-promoted', resolve);
        });
        moderatorSocket.disconnect();
        await new Promise(resolve => setTimeout(resolve, 200));
        ...
        const secondPromotionPromise = new Promise((resolve) => {
    ...
    it('should allow auto-promoted moderator to manually promote others', async () => {
        ...
        const manualPromotionPromise = new Promise((resolve) => {
            participant2Socket.once('moderator-promoted', resolve);
        });
...
//# sourceMappingURL=moderator-succession.test.js.map